...
import de.fraunhofer.iese.ids.odrl.pap.model.Policy.INextPolicyAction;
...
@Data
public class NextPolicyAction extends Action implements INextPolicyAction {
 ActionType type;
 EventCondition eventRefinement;

 public NextPolicyAction()
 {
  this.type = ActionType.NEXTPOLICY;
 }

 public NextPolicyAction(EventCondition eventRefinement) {
  this.type = ActionType.NEXTPOLICY;
