...
@Data
public class PermissionRuleUseAction implements IPermissionRuleUseAction {
 RuleType type;
 UseAction useAction;
 ...
 public PermissionRuleUseAction()
 {
  this.type = RuleType.PERMISSION;
 }

 public PermissionRuleUseAction(IUseAction useAction)
 {
  this.type = RuleType.PERMISSION;
 ...
 public String toString() {
  ...
  return  "  \"" + RuleType.PERMISSION.getOdrlRuleType() + "\": [{    \r\n" +
          useAction.toString() + getDutyBlock() + getConstraintBlock(conditions) + "\r\n" +
          "  }]    \r\n";
 }
