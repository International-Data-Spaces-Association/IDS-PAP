...
@Data
public class RecipientCondition {
 ConditionType type;
 Operator operator;
 ...
 public RecipientCondition()
 {
  this.leftOperand = LeftOperand.RECIPIENT;
 }

 public RecipientCondition(ConditionType conditionType, RightOperand rightOperand, String comment) {
