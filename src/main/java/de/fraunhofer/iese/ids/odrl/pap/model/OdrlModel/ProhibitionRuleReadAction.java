...
import de.fraunhofer.iese.ids.odrl.pap.model.Policy.IProhibitionRuleReadAction;
...
@Data
public class ProhibitionRuleReadAction implements IProhibitionRuleReadAction {
 RuleType type;
...
private String solution = "";
 ...
 public ProhibitionRuleReadAction()
 {
  this.type = RuleType.PROHIBITION;
 }

 public ProhibitionRuleReadAction(IReadAction readAction)
 {
  this.type = RuleType.PROHIBITION;
 ...
 public String toString() {
  return  "  \"" + RuleType.PROHIBITION.getOdrlRuleType() + "\": [{    \r\n" +
          readAction.toString() + getConstraintBlock() + "\r\n" +
          "  }]    \r\n";
 }
