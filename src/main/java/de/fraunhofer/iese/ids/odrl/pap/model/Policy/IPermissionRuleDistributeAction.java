...
public interface IPermissionRuleDistributeAction {

	public RuleType getType();
	public void setType(RuleType type);

	public IDistributeAction getDistributeAction();
	...
	public INextPolicyAction getNextPolicyDutyAction();
	public void setNextPolicyDutyAction(INextPolicyAction NextPolicyAction);

	public EventCondition getEventDutyConstraint();
	public void setEventDutyConstraint(EventCondition eventDutyConstraint);

	public URI getNextPolicyTarget();
	public void setNextPolicyTarget(URI nextPolicyTarget);
