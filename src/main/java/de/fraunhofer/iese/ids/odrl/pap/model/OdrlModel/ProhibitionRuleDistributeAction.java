...
import de.fraunhofer.iese.ids.odrl.pap.model.Policy.IProhibitionRuleDistributeAction;
...
@Data
public class ProhibitionRuleDistributeAction implements IProhibitionRuleDistributeAction {
 RuleType type;
...
private String solution = "";
 ...
 public ProhibitionRuleDistributeAction()
 {
  this.type = RuleType.PROHIBITION;
 }

 public ProhibitionRuleDistributeAction(IDistributeAction distributeAction)
 {
  this.type = RuleType.PROHIBITION;
 ...
 public String toString() {
  return  "  \"" + RuleType.PROHIBITION.getOdrlRuleType() + "\": [{    \r\n" +
          distributeAction.toString() + getConstraintBlock() + "\r\n" +
          "  }]    \r\n";
 }
